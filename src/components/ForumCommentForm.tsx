    ...
    <section
      className={clsx(
        ...
        variant === "full"
          ...
          : "border-l border-canopy-900/15 py-2 pl-3"
      )}
    >
      <h2
        className={clsx(
      ...
      <textarea
        ...
        className={clsx(
          ...
          variant === "full"
            ? "min-h-24"
            : "min-h-16 bg-white/75 text-sm shadow-sm"
        )}
      ...
      <div className="flex flex-wrap items-center gap-2">
        <button
          aria-label={variant === "compact" ? submitLabel : undefined}
          className={clsx(
          ...
          disabled={saving}
          onClick={submit}
          title={variant === "compact" ? submitLabel : undefined}
          type="button"
        >
        ...
        {onCancel ? (
          <button
            aria-label={variant === "compact" ? "Cancel" : undefined}
            className={clsx(
            ...
            disabled={saving}
            onClick={onCancel}
            title={variant === "compact" ? "Cancel" : undefined}
            type="button"
          >
